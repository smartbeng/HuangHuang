package com.lansum.eip.http;

/**
 * Created by ShiYunPeng on 2017/4/5.
 */
...
public class Constants {
    ...
    //请假
    public static String urlQingJia="leave.html";

    //工作日志
    public static String urlGongZuoRiZhi="plan.html";

    //项目管理
    public static String urlXiangMuGuanLi="manage.html";

    //更新请求地址
    public static String urlUpdataApk="http://jcodecraeer.com/update.php";

    //发表日志
    public static String urlFaBiaoRiZhi = "publish.html?WebViewRefreshNotification=publish";

    //考核
    public static String urlPerformance = "performance.html";
}
