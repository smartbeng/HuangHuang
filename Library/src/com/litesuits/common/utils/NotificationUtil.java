...
public class NotificationUtil {
	...
	public static void notification(Context context, String activityClass, Bundle bundle, int icon, String ticker,
	...
	public static void notification(Context context, Intent intent, int id, int icon, String ticker, String title,
			String msg) {
		PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
		notification(context, pendingIntent, id, icon, ticker, title, msg);
	}

	public static void notification(Context context, PendingIntent pendingIntent, int id, int icon, String ticker,
			String title, String msg) {
	...
	public static void notification(Context context, int flags, int id, int icon, String ticker, String title,
			String msg) {
	...
	public static void notification(Context context, String msg) {
		i++;
		PendingIntent pendingIntent = PendingIntent.getActivity(context, 1, new Intent(),
				Notification.FLAG_AUTO_CANCEL);
		notification(context, pendingIntent, i, com.litesuits.common.R.drawable.ic_launcher, "您有新消息，请注意查看！！！", "晃晃办公",
				msg);
